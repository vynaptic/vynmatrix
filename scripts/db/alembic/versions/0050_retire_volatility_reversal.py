"""Retire VolatilityReversal without deleting historical lineage.

Revision ID: 0050_retire_vol_reversal_v1
Revises: 0049_retire_enhanced_dual_v1
"""
...
revision = "0050_retire_vol_reversal_v1"
down_revision = "0049_retire_enhanced_dual_v1"
branch_labels = None
depends_on = None


_RETIRED_STRATEGY_ID = "volatility_reversal_v1"
    ...
    op.execute(
        ...
        BEGIN
            ...
            IF actionable_count <> 0 THEN
                RAISE EXCEPTION
                    'VolatilityReversal retirement left % actionable records',
                    actionable_count;
            END IF;
        END $$;
        """
