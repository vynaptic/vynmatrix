"""Retire QuantileChannel without deleting historical lineage.

Revision ID: 0048_retire_quantile_v1_2
Revises: 0047_quarantine_quantile_v1_2
"""
...
revision = "0048_retire_quantile_v1_2"
down_revision = "0047_quarantine_quantile_v1_2"
branch_labels = None
depends_on = None


_RETIRED_STRATEGY_ID = "quantile_channel_v1"
    ...
    op.execute(
        ...
        BEGIN
            ...
            IF actionable_count <> 0 THEN
                RAISE EXCEPTION
                    'QuantileChannel retirement left % actionable records',
                    actionable_count;
            END IF;
        END $$;
        """
