"""Retire VortexRSIProfitTarget without deleting historical lineage.

Revision ID: 0046_quarantine_vrpt_v1_2
Revises: 0045_retire_stat_reg_channel
"""
...
revision = "0046_quarantine_vrpt_v1_2"
down_revision = "0045_retire_stat_reg_channel"
branch_labels = None
depends_on = None


_RETIRED_STRATEGY_ID = "vortex_rsi_profit_target_v1"
    ...
    op.execute(
        ...
        BEGIN
            ...
            IF actionable_count <> 0 THEN
                RAISE EXCEPTION
                    'VortexRSIProfitTarget retirement left % actionable records',
                    actionable_count;
            END IF;
            ...
            IF actionable_feedback_count <> 0 THEN
                RAISE EXCEPTION
                    'VortexRSIProfitTarget retirement left % actionable feedback records',
