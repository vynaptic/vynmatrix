"""Retire StatValidatedRegChannelBreakout without deleting historical lineage.

Revision ID: 0045_retire_stat_reg_channel
Revises: 0044_retire_ma_slope
"""
...
revision = "0045_retire_stat_reg_channel"
down_revision = "0044_retire_ma_slope"
branch_labels = None
depends_on = None


_RETIRED_STRATEGY_ID = "stat_validated_reg_channel_breakout_v1"
    ...
    op.execute(
        ...
        BEGIN
            ...
            IF actionable_feedback_count <> 0 THEN
                RAISE EXCEPTION
                    'StatValidated retirement left % actionable feedback records',
