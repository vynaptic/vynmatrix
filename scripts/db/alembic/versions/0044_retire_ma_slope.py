"""Retire MaSlope without deleting historical lineage.

Revision ID: 0044_retire_ma_slope
Revises: 0043_retire_vortex_trend_capture
"""
...
revision = "0044_retire_ma_slope"
down_revision = "0043_retire_vortex_trend_capture"
branch_labels = None
depends_on = None


_RETIRED_STRATEGY_ID = "ma_slope_v1"
...
def _converge_retired_state() -> None:
    """Fail closed around in-flight work, then disable MaSlope execution."""
    ...
    op.execute(
        ...
        -- Catalogue/version locks prevent concurrent actionable feedback from
        -- escaping this convergence transaction.
        ...
        BEGIN
            ...
            IF actionable_feedback_count <> 0 THEN
                RAISE EXCEPTION
                    'MaSlope retirement left % actionable feedback records',
